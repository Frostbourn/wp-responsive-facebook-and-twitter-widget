...
Contributors: frostbourn, freemius
...
* Pinterest
* Custom HTML tab
* Multiple icons styles
* Credit link removal
* Unlimited sites ticket based VIP support
* Lifefime software updates & VIP support
...
3. Use the Settings -> Facebook and Twitter Responsive Widget screen to configure the plugin
...
[Documentation](https://github.com/Frostbourn/wp-responsive-facebook-and-twitter-widget)
